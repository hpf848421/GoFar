...
- (void)addADScrollView:(NSInteger)count height:(CGFloat)heightValue
{
    ...
    CGSize newSize = CGSizeMake(WIDTH * (count + 2),  heightValue);//设置scrollview的大小
...
//            egoimg.placeholderImage=[UIImage imageNamed:@"影视背景.jpg"];
                [egoimg setImageURL:[NSURL URLWithString:imageURL]];
...
- (void)addPageControl:(NSInteger)count
{
    ...
    pageControl = [[UIPageControl alloc]initWithFrame:rect];
        pageControl.center=CGPointMake(KscreenW*0.5, self.height-20);
    pageControl.numberOfPages = count;
    pageControl.pageIndicatorTintColor = HPcolor(200, 200, 200);
